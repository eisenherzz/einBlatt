...
Pik & Gewndheit & 8 (8 x 3=24 Einkaufspunkte)\\
...
\twocolumn
Nun macht er sich an die Fertigkeiten. Zuerst Kopf (das geht am schnellsten, weil er da nur 3 Stück braucht):
\begin {enumerate}
\item Orientierung
\item Tierkunde
\item Orkische Sprache
\end {enumerate}

Dann Herz -- das sind schon 5:
\begin {enumerate}
\item Einschüchtern
\item Lügen ahnen
\item Männer führen
\item Mut
\item Mitreißend singen
\end {enumerate}

Der Körper bekommt zwar 7 Fertigkeiten, doch die werden Hendrik schnell von der Hand gehen:
\begin {enumerate}
\item Axt
\item Schild
\item Schwert
...
Die 5 Ahnen von Superhendrik sind folgende:
\begin {enumerate}
\item Inna (seine Großmutter, die berühmt wurde, weil sie mit bloßen Händen Wölfe zur Strecke brachte)
\item Ragnulf (ein Skalde, der vor 100 Jahren starb, dessen Lieder aber noch heute gesungen werden)
\item Ulf (sein Großonkel und der beste Seemann seiner Zeit)
\item Ingmar (der einzige aus seiner Familie, der jemals Hetmann seiner eigenen Otta war)
\item Hildrun (Eine Hexe, die vor 700 Jahren einen Halbgott hereinlegte, um mit ihm Superhendriks Familie zu zeugen)
\end {enumerate}
...
"`Was soll die Axt denn an Deinem Kopf?"' fragt Hendrik. 
